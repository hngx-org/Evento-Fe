import Button, { ButtonVariants } from '@ui/NewButton';
...
const SignUpWithSocialsButton: FC<ButtonProps> = ({ children, leftIcon, ...props }) => {
  ...
  return (
    <button
      className={`${workSans.className} w-full bg-white-100 text-custom-color20 border-custom-color21 border rounded-md hover:bg-white-100 sm:text-base flex justify-center items-center py-3 md:py-4 gap-2`}

      ...
      <div className="flex justify-center my-20 items-center m-auto">
        ...
        >
          ...
          <form className="rounded-xl flex-col gap-6 flex">
            <label className="gilroy text-[14px] font-[600] leading-[20.3px] text-[#303030] ">Full Name</label>
            <input
              type="text"
            ...
            <button
              ...
              className="bg-[#e0580c] mt-6 mb-3 text-[#fefefe] rounded-[8px] flex justify-center items-center px-[20px] py-[16px] w-full text-[16px] font-[400] "
            >
              Continue
            </button>
          </form>
          <div className="flex gap-2 text-[16px] font-[400] leading-6 text-[#111] ">
            ...
            <Link href="/login" className="text-[#e0580c] font-[500]">
              Log in
            </Link>
          </div>
        </div>

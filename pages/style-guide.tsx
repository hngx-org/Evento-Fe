import { Input, SelectInput } from '@ui/NewInput';
...
const codes = [
  {
    ...
    <Button
          ...
          isLoading={true}
          spinnerColor="#000"
          className='bg-Success-S500' // specify classname hear instead
          >
              Primary
      </Button>`,
  },
  {
    ...
    <Button
          ...
          intent={'secondary'} // optional 
          size={'md'}
          isLoading={true}
          spinnerColor="#000"
          className='bg-Success-S500' // specify CalssName
          >
              Secondary
      </Button>`,
  },
    ...
    <div>
      ...
      <ul className="flex flex-wrap md:flex-nowrap gap-6 py-5 px-9">
        <li className="mr-6 mb-4 md:mb-0">
          <a className="text-primary-100 hover:text-green-800" href="#buttons">
            Buttons
          </a>
        </li>
        <li className="mr-6 mb-4 md:mb-0">
          <a className="text-primary-100 hover:text-green-800" href="#toasts">
            Toast
          </a>
        </li>

        <li className="mr-6 mb-4 md:mb-0">
          <a className="text-primary-100 hover:text-green-800" href="#inputs">
            Inputs
          </a>
        </li>
      </ul>
      ...
      <div className="py-0 px-9" id="buttons">
        ...
        <div className="flex items-center justify-center gap-9">
          ...
          <Button leftIcon={<I24Support color="#fff" />} onClick={onOpen} size={'md'} className="bg-Success-S500">
            Open Modal
          </Button>
        </div>
        <div className="flex items-center justify-center gap-9 pt-10">
          <Button onClick={() => setCodeSelected(5)} size={'sm'} className="bg-Success-S500">
            Size - sm
          </Button>
          <Button intent={'primary'} onClick={() => setCodeSelected(6)} size={'lg'} className="bg-Success-S500">
            Size - lg
          </Button>
          <Button
            leftIcon={<I24Support color="#fff" />}
      ...
      <div className="py-1 px-9 pb-10" id="toasts">
        ...
        <div className="flex items-center justify-center gap-9">
          <Button className="bg-primary-100" onClick={() => handleToast()} size={'md'}>
            Show Toast
          </Button>
        </div>

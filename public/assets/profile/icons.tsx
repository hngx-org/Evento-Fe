...
export const CalendarIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={60} height={67} fill="none" focusable="true">
    <path
      fill="#E0580C"
      d="M43.333 30.333H16.667a3.343 3.343 0 0 0-3.334 3.334c0 1.833 1.5 3.333 3.334 3.333h26.666c1.834 0 3.334-1.5 3.334-3.333 0-1.834-1.5-3.334-3.334-3.334ZM53.333 7H50V3.667C50 1.833 48.5.333 46.667.333a3.343 3.343 0 0 0-3.334 3.334V7H16.667V3.667c0-1.834-1.5-3.334-3.334-3.334A3.343 3.343 0 0 0 10 3.667V7H6.667A6.667 6.667 0 0 0 0 13.667v46.666A6.667 6.667 0 0 0 6.667 67h46.666C57 67 60 64 60 60.333V13.667C60 10 57 7 53.333 7ZM50 60.333H10A3.343 3.343 0 0 1 6.667 57V23.667h46.666V57c0 1.833-1.5 3.333-3.333 3.333ZM33.333 43.667H16.667A3.343 3.343 0 0 0 13.333 47c0 1.833 1.5 3.333 3.334 3.333h16.666c1.834 0 3.334-1.5 3.334-3.333 0-1.833-1.5-3.333-3.334-3.333Z"
    />
  </svg>
);

export const TwitterIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={22} height={17} fill="none" focusable="true" {...props}>
    <path
      fill="#1E1E1E"
...
export const GridIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" focusable="true" {...props}>
    <path
      stroke="#E0580C"
      strokeLinecap="round"
